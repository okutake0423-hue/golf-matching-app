      ...
      const response = await fetch('/api/notify/bulk', {
        ...
        body: JSON.stringify({
          ...
          scheduleInfo: {
            ...
            reservationName: schedule.reservationName,
            meetingTime: schedule.meetingTime,
            competitionPlayFee: schedule.competitionPlayFee,
            competitionPlayFeeKuratthai: schedule.competitionPlayFeeKuratthai,
            caddieFee: schedule.caddieFee,
