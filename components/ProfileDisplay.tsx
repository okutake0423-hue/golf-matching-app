...
type Props = {
  ...
  onCaddyProfiles?: () => void;
  onLogout?: () => void;
  onSchedules?: () => void;
  onMahjongSchedules?: () => void;
};

export function ProfileDisplay({ profile, onEdit, onProfileRegistrants, onMatsushitaKai, onCaddyProfiles, onLogout, onSchedules, onMahjongSchedules }: Props) {
  ...
  return (
    <div className={styles.profile}>
      ...
      <div className={styles.actions}>
        ...
        {onCaddyProfiles && (
          <button type="button" onClick={onCaddyProfiles} className={styles.buttonEdit}>
            キャディープロフィール
          </button>
        )}
        {onEdit && (
